...
public class ArrowAnimated implements ApplicationListener {
    ...
    public ArrowAnimated(Vector2 position1, Vector2 position2, SpriteBatch batch) {
    ...
    public void create() {
        ...
        texture = new Texture(Gdx.files.internal("./BuildingBlocks/arrow.png"));
